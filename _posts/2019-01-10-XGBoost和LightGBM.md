...
<a href="https://www.codecogs.com/eqnedit.php?latex=\dpi{150}&space;\bg_black&space;\large&space;Obj(\Theta)=\sum\limits_il(y_i,&space;\hat&space;y_i)&plus;\sum\limits_k\Omega(f_k)&space;\Omega(f)=\gamma&space;T&plus;\dfrac{1}{2}\lambda||w||^2" target="_blank"><img src="https://latex.codecogs.com/png.latex?\dpi{150}&space;\bg_black&space;\large&space;Obj(\Theta)=\sum\limits_il(y_i,&space;\hat&space;y_i)&plus;\sum\limits_k\Omega(f_k)&space;\Omega(f)=\gamma&space;T&plus;\dfrac{1}{2}\lambda||w||^2" title="\large Obj(\Theta)=\sum\limits_il(y_i, \hat y_i)+\sum\limits_k\Omega(f_k) \Omega(f)=\gamma T+\dfrac{1}{2}\lambda||w||^2" /></a>
